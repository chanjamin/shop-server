...
module.exports = {
    default_module: 'api',
    weixin: {
        appid: 'wxf5bef5ca5c73c7ed', // 小程序 appid
        secret: 'fc3e33110a435e1ea067a8b03b7da56c', // 小程序密钥
        mch_id: '15988888888', // 商户帐号ID
        partner_key: 'asdasdasdasdasdasdasd', // 微信支付密钥
        notify_url: 'https://jamin.site/api/pay/notify' // 微信支付异步通知
    },
   //  express: {
   ...
   //  },
    qiniu: {
        access_key: 'fgJ-XAixTy4hSYf_RQzzOJEBmVlYQZqcVBZ90hsu',      // 在七牛密钥管理中获取
        secret_key: 'UdT6xy_gDeXX9D7CppmOn0kM3SipvrB0dSbc8E1Q',    // 在七牛密钥管理中获取
        bucket: 'bucket-jamin',                    // 请填自己的bucket的名称
        domain: 'http://qllbogb91.hn-bkt.clouddn.com/'                         // 请填自己的domain域名
    },
	...
	// 	sfLastNo:'0580', // 顺丰寄件人后四位，这个根据自己的寄件人手机设置，如果寄件人是不固定的，那么需要在order_express写代码了。
    // },
	templateId:{
		// deliveryTemplate:
	}
